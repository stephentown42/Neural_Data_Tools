function eData = get_depth_vs_date( file_path, file_name, draw, chan)
%eData = get_depth_vs_date( file_path, file_name, draw)
%
% INPUT:
...
%                      vs. time
%   - chan (optional): filter for specific channel
%
% RETURNS:
...
eData = get_electrode_data( file_path, file_name, draw, chan);


function F = get_electrode_data( file_path, file_name, draw, chan)
